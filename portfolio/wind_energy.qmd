...
energy analytics. We were looking at ways to predict the wind energy at a site using machine learning. It is necessary to
...
open source it so other analysts can find it useful. It ended up being a popular project with many adopting the tool
