...
### The story
The work in Edge AI was done mainly under a technology demonstrator (or proof of concept) for [CeADAR](https://ceadar.ie/) - Ireland's Center for Applied AI, which can be checked [here](https://ceadar.ie/blog/edge-ai/).
