...
<center>
<figure>
    <img src="../images/sonalake/decomposition.png" height=70%>
    <figcaption> <center> Fig. 1: Decomposition of time series to better predict trends in KPIs</center></figcaption>
</figure>
</center>

1. Anomaly detection is another area where telecom networks need some, as there are literally hundreds of KPIs
a company like Vodafone monitors and automated ways to detect anomalies can improve quality of service. We used
several methods to detect anomalies automatically in each of their KPIs and flag them in a timely manner.
<center>
<figure>
    <img src="../images/sonalake/anomaly_det.png" height=60%>
...
<center>
<figure>
    <img src="../images/sonalake/som.png">
