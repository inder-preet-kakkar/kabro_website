...
And the solution proposed is, Quantization Aware Scaling (QAS) where they reduce this ratio mismatch by compensating the gradient by the square of the scaling factor. The QAS is shown by the yellow line in the graph and it closely match the blue line for the unquantized 32 bits DNN.
...
Hope this brief overview kindled your interest in this line of research and if yes, do read their paper.
